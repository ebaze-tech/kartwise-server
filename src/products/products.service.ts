...
export class ProductsService {
  ...
  async findProducts(
    userId: string,
  ): Promise<{ message: string; data: ProductsDto[] }> {
    ...
    if (!products) throw new UnauthorizedException('Products not found');

    return {
      message: 'Products retrieved successfully',
      data: products as unknown as ProductsDto[],
    };
  }
  ...
  async findProductById(
    ...
    return {
      ...
      data: product as unknown as ProductsDto,
    };
  }
}
