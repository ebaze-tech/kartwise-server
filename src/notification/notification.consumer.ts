...
export class NotificationConsumer {
  ...
  @EventPattern('business.created')
  async handleBusinessCreatedEvent(@Payload() event: BusinessCreatedEvent) {
    return await this.notificationService.sendBusinessWelcomeEmail(event);
  }
}
